# Workflow: TMT11_MS3_Val_Workflow
...
msfragger.misc.fragger.enzyme-dropdown-2=lysc
...
msfragger.search_enzyme_cut_2=K
msfragger.search_enzyme_name_1=stricttrypsin
msfragger.search_enzyme_name_2=lysc
...
workflow.description=<p style\="margin-top\: 0">TMT 11-plex workflow, MS3-level quantification and identification from low mass accuracy MS2. Met oxidation, protein N-term Acetyl, and n-term TMT specified as variable modifications. PSM validation with Percolator. Philosopher quant extraction, TMT-Integrator with real bridge/reference channel (add_Ref\=-1), median-centering normalization. Tag the 126 bridge sample name with 'Bridge' in the annotation file(s); 131C technical-control channel should get a distinct name so it is not used as the ratio reference. Run TMT-Integrator per-tissue to keep cortex/hippocampus bridging separate.</p>
